(function () {
  ...
  function renderSlip(calc) {
    ...
    const statutoryDetails = c.directFixed ? "" : `${detail("UAN", validUan, true)}${detail("PF NUMBER", pfNumber, true)}`;
